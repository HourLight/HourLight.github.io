...
(function(){
  ...
  var HTML = ''
    ...
    + '<tbody>'
    + '<tr><td>AI 深度解讀指令<br><span style="font-size:.7rem;color:rgba(244,240,235,.55)">命盤、合盤、紫微等 34+ 工具</span></td><td class="c">3 次/天</td><td class="c">10 次/天</td><td class="c">無限</td></tr>'
    + '<tr><td>占卜工具計次<br><span style="font-size:.7rem;color:rgba(244,240,235,.55)">塔羅、易經、天使、骨牌、夢境、鏡像、季節等</span></td><td class="c">3 次/天<br><span style="font-size:.66rem">每工具獨立</span></td><td class="c">10 次/天<br><span style="font-size:.66rem">每工具獨立</span></td><td class="c">無限</td></tr>'
    ...
    + '• 占卜工具每個獨立計次：例如塔羅 10 次/天 + 易經 10 次/天，互不影響。<br>'
