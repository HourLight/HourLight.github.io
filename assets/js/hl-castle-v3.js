...
(function(){
  ...
  var DAILY_QUEST_POOL = [
    // ── 探訪類（房間互動） ──
    { id:'visit3rooms',   text:'今日探訪 3 個不同房間',           target:3, type:'room_visit',    reward:{ xp:25, points:2 } },
    { id:'visit5rooms',   text:'深度巡禮 5 個房間',               target:5, type:'room_visit',    reward:{ xp:40, points:4 } },
    { id:'visit_all',     text:'巡遊所有 21 個房間',              target:21,type:'room_visit',    reward:{ xp:200, points:20 } },
    { id:'event3',        text:'觸發 3 個房間事件',                target:3, type:'event',         reward:{ xp:22, points:2 } },
    { id:'event5',        text:'觸發 5 個房間事件',                target:5, type:'event',         reward:{ xp:38, points:4 } },
    // ── 抽牌類 ──
    ...
    { id:'draw_tarot',    text:'抽一張塔羅牌',                     target:1, type:'draw_card',     reward:{ xp:12, points:2 } },
    { id:'draw_angel',    text:'抽一張天使卡',                     target:1, type:'draw_card',     reward:{ xp:12, points:2 } },
    // ── 測驗類 ──
    { id:'quiz1',         text:'完成 1 個心理測驗',                target:1, type:'quiz_complete', reward:{ xp:15, points:2 } },
    { id:'quiz2',         text:'完成 2 個不同測驗',                target:2, type:'quiz_complete', reward:{ xp:35, points:4 } },
    ...
    { id:'fuling_mima',   text:'查看自己的馥靈秘碼',                target:1, type:'destiny',        reward:{ xp:15, points:2 } },
    // ── 傢具 / 材料類 ──
    ...
    { id:'collect_rare',  text:'集滿 3 個 Rare 材料',              target:3, type:'material',      reward:{ xp:35, points:4 } },
    { id:'exchange_mat',  text:'在兌換所換取一次材料',             target:1, type:'exchange',      reward:{ xp:20, points:0 } },
    // ── 寵物類 ──
    { id:'feed_pet',      text:'餵食寵物 1 次',                    target:1, type:'pet_feed',      reward:{ xp:15, points:2 } },
    { id:'pet_play',      text:'陪寵物玩耍',                        target:1, type:'pet_play',      reward:{ xp:12, points:2 } },
    ...
    // ── 覺察行動類 ──
    { id:'breathe3',      text:'做一次 3 分鐘呼吸練習',             target:1, type:'breathe',       reward:{ xp:18, points:2 } },
    { id:'write_journal', text:'寫一段今日覺察日記',                target:1, type:'journal',       reward:{ xp:22, points:2 } },
    { id:'oil_today',     text:'查看今日精油建議',                  target:1, type:'aroma',         reward:{ xp:12, points:2 } },
    { id:'meditation',    text:'進行一次冥想引導',                  target:1, type:'meditation',    reward:{ xp:25, points:2 } },
    // ── 彩蛋 / 進階類 ──
    { id:'all_quests',    text:'今日三任務全達成（元任務）',        target:3, type:'quest_complete',reward:{ xp:75, points:8 } },
    { id:'midnight_visit',text:'在子時（23:00-01:00）探訪城堡',    target:1, type:'room_visit',    reward:{ xp:40, points:5 } },
    { id:'dawn_visit',    text:'在辰時（07:00-09:00）探訪城堡',    target:1, type:'room_visit',    reward:{ xp:30, points:4 } }
  ];
