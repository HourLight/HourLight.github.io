...
(function(){
  ...
  var DAILY_QUEST_POOL = [
    // ── 探訪類（房間互動） ──
    { id:'visit3rooms',   text:'今日探訪 3 個不同房間',           target:3, type:'room_visit',    reward:{ xp:20,  points:2  } },
    { id:'visit5rooms',   text:'深度巡禮 5 個房間',               target:5, type:'room_visit',    reward:{ xp:35,  points:3  } },
    { id:'visit_all',     text:'巡遊所有 21 個房間',              target:21,type:'room_visit',    reward:{ xp:100, points:10 } },
    { id:'event3',        text:'觸發 3 個房間事件',                target:3, type:'event',         reward:{ xp:20,  points:2  } },
    { id:'event5',        text:'觸發 5 個房間事件',                target:5, type:'event',         reward:{ xp:35,  points:3  } },
    // ── 抽牌類 ──
    { id:'draw3cards',    text:'抽 3 張馥靈牌（單張）',           target:3, type:'draw_card',     reward:{ xp:15,  points:2  } },
    { id:'draw5cards',    text:'抽 5 張馥靈牌',                    target:5, type:'draw_card',     reward:{ xp:25,  points:2  } },
    { id:'draw_spread',   text:'完成一次 3 張牌陣占卜',            target:1, type:'draw_spread',   reward:{ xp:30,  points:3  } },
    { id:'draw_tarot',    text:'抽一張塔羅牌',                     target:1, type:'draw_card',     reward:{ xp:12,  points:1  } },
    { id:'draw_angel',    text:'抽一張天使卡',                     target:1, type:'draw_card',     reward:{ xp:12,  points:1  } },
    // ── 測驗類 ──
    { id:'quiz1',         text:'完成 1 個心理測驗',                target:1, type:'quiz_complete', reward:{ xp:15,  points:2  } },
    { id:'quiz2',         text:'完成 2 個不同測驗',                target:2, type:'quiz_complete', reward:{ xp:35,  points:3  } },
    { id:'quiz_mbti',     text:'完成 MBTI 或九型人格測驗',         target:1, type:'quiz_complete', reward:{ xp:20,  points:2  } },
    { id:'quiz_awareness',text:'完成任一覺察測驗（深潛類）',       target:1, type:'quiz_complete', reward:{ xp:25,  points:2  } },
    // ── 命理類 ──
    { id:'destiny_run',   text:'計算一次命盤（任一工具）',         target:1, type:'destiny',        reward:{ xp:20,  points:2  } },
    { id:'destiny2',      text:'使用 2 套不同命理工具',             target:2, type:'destiny',        reward:{ xp:40,  points:4  } },
    { id:'destiny_match', text:'計算一次合盤（你與某人）',         target:1, type:'destiny_match',  reward:{ xp:30,  points:3  } },
    { id:'fuling_mima',   text:'查看自己的馥靈秘碼',                target:1, type:'destiny',        reward:{ xp:15,  points:1  } },
    // ── 傢具 / 材料類 ──
    { id:'furniture1',    text:'合成 1 件傢具',                    target:1, type:'furniture',     reward:{ xp:30,  points:3  } },
    { id:'furniture2',    text:'合成 2 件傢具',                    target:2, type:'furniture',     reward:{ xp:60,  points:6  } },
    { id:'upgrade_room',  text:'升級任一房間',                     target:1, type:'room_upgrade',  reward:{ xp:50,  points:5  } },
    { id:'collect_rare',  text:'集滿 3 個 Rare 材料',              target:3, type:'material',      reward:{ xp:35,  points:3  } },
    { id:'exchange_mat',  text:'在兌換所換取一次材料',             target:1, type:'exchange',      reward:{ xp:20,  points:0  } },
    // ── 寵物類 ──
    { id:'feed_pet',      text:'餵食寵物 1 次',                    target:1, type:'pet_feed',      reward:{ xp:15,  points:1  } },
    { id:'pet_play',      text:'陪寵物玩耍',                        target:1, type:'pet_play',      reward:{ xp:12,  points:1  } },
    { id:'pet_communicate',text:'做一次寵物溝通抽牌',              target:1, type:'pet_draw',      reward:{ xp:25,  points:2  } },
    // ── 社交分享類 ──
    { id:'share_castle',  text:'分享你的城堡給朋友',               target:1, type:'share',         reward:{ xp:50,  points:8  } },
    { id:'share_result',  text:'分享一次測驗或命盤結果',           target:1, type:'share',         reward:{ xp:30,  points:4  } },
  ...
  var LORD_LEVEL_REWARDS = [
    ...
    { lv:30,  icon:'⚡', title:'連登材料獎勵 +1',            desc:'每次 streak 觸發多掉 1 個 common 材料（點數不翻倍）' },
