...
(function(){
  ...
  function isInteractive(el){
    ...
    if (tag==='a') {
      ...
      if (!el.getAttribute('onclick') && /^(https?:|mailto:|tel:|#|[a-z].*\.html)/.test(href)) return false;
    }
  ...
  function createOverlay(){
    ...
    overlayEl.innerHTML = '<div style="text-align:center;max-width:420px;padding:48px 32px;animation:hlGF .5s ease">'
      ...
      + '<div style="font-size:20px;color:#e9c27d;letter-spacing:.12em;margin-bottom:10px;font-weight:300">登入後，這些工具都是你的</div>'
