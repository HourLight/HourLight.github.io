...
def build_knowledge_posts():
    ...
    pages = [
        ...
        {
            "file": "nine-purple-fire-guide.html",
            "title": "九紫離火運完整指南",
            "angles": [
                {
                    "hook": "你可能聽過身邊的人說「現在正在走九紫離火運」。這不是口號，是 180 年三元九運的第九運，時間表嚴謹，能量特徵清楚。",
                    "body": "2024-2043 這 20 年的主調是火、是光、是向上的、是精神層次的。跟它同頻的事情會爆發，跟它逆頻的事情會消退。",
                    "tag": "九紫離火",
                },
                {
                    "hook": "離卦對應中女。這 20 年，30-50 歲女性會是社會的新中堅，帶動美業、文化、心靈、教育、永續這幾個領域。",
                    "body": "過去壓著你的那些規則，在九運會慢慢鬆開。你人生的很多卡點，不是你個人的問題，是上一運的能量不合你。",
                    "tag": "女性崛起",
                },
                {
                    "hook": "九紫離火運對美業是結構性順風 20 年。但老派技術競爭會被「技術 + 情緒 + 意義感」取代，只會做臉做甲做指壓的人會被追著跑。",
                    "body": "把技術跟身心照顧語言綁在一起、建立個人品牌、多學儀式感設計。這是接下來 20 年的生存方式。",
                    "tag": "美業順風",
                },
            ],
        },
