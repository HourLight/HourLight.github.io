    ...
    switch (type) {
      ...
      default:
        return res.status(400).json({
          error: '未指定服務類型，請使用 ?type=akashic|yuan-chen|past-life|name|wallpaper|abundance-prayer|monthly-gift|skin-compare|nail',
          availableTypes: ['akashic', 'yuan-chen', 'past-life', 'name', 'wallpaper', 'abundance-prayer', 'skin-compare', 'nail']
        });
    }
  } catch (err) {
