...
(function(global) {
  ...
  const _DECK_STRUCTURE = {
    ...
    aroma: {
      count: 108,
      name: '芳香能量卡',
      description: '108張芳香能量卡，結合精油與情緒覺察'
    }
  };
  
  // === 數字對應分類（公開資訊） ===
  const _NUMBER_CATEGORIES = {
    1: { theme: '領導、開創與決策能量', shadow: '拖延症、思而不動' },
    2: { theme: '協調、平衡與感知能量', shadow: '依賴、不信任自己' },
    3: { theme: '表達、創造與樂觀能量', shadow: '虎頭蛇尾、逃避' },
    4: { theme: '穩定、建設與務實能量', shadow: '僵化、恐懼改變' },
    5: { theme: '自由、變化與冒險能量', shadow: '焦躁、逃避承諾' },
    6: { theme: '愛、責任與服務能量', shadow: '控制、過度付出' },
    7: { theme: '內省、智慧與靈性能量', shadow: '疏離、過度分析' },
    8: { theme: '權力、豐盛與影響能量', shadow: '控制、工作狂' },
    9: { theme: '慈悲、智慧與完成能量', shadow: '理想化、脫節' }
  };
