...
(function(global) {
  ...
  const _ND = {
    ...
    7: {
      ...
      im: { tp: '探索者', tr: '需要心靈連結才能身體連結、可能對身體疏離、喜歡研究和探索', hl: '身心合一的深度體驗', sd: '太在腦袋裡，身體不在', ti: '心靈連結是前提，給他時間「回到身體」' }
    },
    8: {
    ...
    9: {
      ...
      im: { tp: '奉獻者', tr: '追求身心合一、可能覺得「性太低層次」、重視意義和連結', hl: '無條件的愛與接納，超越肉體的連結', sd: '逃避身體，只活在精神層面', ti: '連結到更大的意義，幫助他回到身體' }
    },
    11: {
      ...
      im: { tp: '靈性連結者', tr: '需要深度靈性連結、極度敏感、能感應對方的情緒', hl: '身心完全合一的深度體驗', sd: '太敏感而無法放鬆享受', ti: '創造神聖的空間和氛圍' }
    },
    22: {
    ...
    33: {
      ...
      im: true,
      mm: '成為無條件之愛的管道',
      wk: { tp: '守護導師', ds: '「讓我來守護」', st: '服務導向、需要意義感' },
      im: { tp: '守護者', tr: '給予無條件的愛和接納', hl: '讓對方感受到被完全接納', sd: '只付出不接受', ti: '允許自己也被愛' }
    }
  };
  ...
  const _PD = {
    ...
    4: { n: '家族苑', md: '大腸經', tm: '05:00-07:00', th: '我該丟掉什麼？', de: '執著、囤積、黏膩', le: '淨化、釋放、清爽', sp: ['家裡堆滿用不到的東西', '無法結束不適合的關係'], sq: ['你的人生有什麼「廢物」需要清理？'], ao: ['檸檬', '葡萄柚', '茶樹'] },
    5: { n: '創造殿', md: '胃經', tm: '07:00-09:00', th: '我消化不了什麼？', de: '焦慮、擔憂、無法接受', le: '接納、消化、轉化', sp: ['對未來充滿焦慮', '胃部經常不舒服'], sq: ['什麼事情讓你「嚥不下去」？'], ao: ['甜橙', '薑', '豆蔻'] },
    6: { n: '執行廳', md: '脾經', tm: '09:00-11:00', th: '我想太多什麼？', de: '過度思慮、擔憂、控制', le: '信任、臣服、交託', sp: ['什麼事都要想三遍', '很難信任別人'], sq: ['你不信任的是什麼？'], ao: ['檀香', '岩蘭草', '快樂鼠尾草'] },
    7: { n: '合作殿', md: '心經', tm: '11:00-13:00', th: '我渴望什麼愛？', de: '孤獨、隔離、心牆', le: '連結、喜悅、敞開', sp: ['覺得沒有人真正懂自己', '渴望愛卻害怕受傷'], sq: ['你的心牆在保護什麼？'], ao: ['玫瑰', '茉莉', '依蘭依蘭'] },
    8: { n: '轉化廳', md: '小腸經', tm: '13:00-15:00', th: '我分不清什麼？', de: '混亂、困惑、無法判斷', le: '明辨、清晰、智慧', sp: ['常常在選擇中糾結', '分不清誰是真朋友'], sq: ['你內心的聲音在說什麼？'], ao: ['迷迭香', '羅勒', '薄荷'] },
    9: { n: '遠航苑', md: '膀胱經', tm: '15:00-17:00', th: '我扛著什麼？', de: '壓力、緊繃、承擔過度', le: '釋放、輕鬆、流動', sp: ['背部和肩頸總是很緊', '覺得自己要扛所有的事'], sq: ['你背上扛的是誰的責任？'], ao: ['薰衣草', '甜馬鬱蘭', '苦橙葉'] },
    10: { n: '榮耀殿', md: '腎經', tm: '17:00-19:00', th: '我害怕什麼？', de: '恐懼、無力、迷失方向', le: '志氣、方向、生命力', sp: ['不知道人生要往哪裡去', '害怕失敗所以不敢開始'], sq: ['如果不害怕，你想成為什麼？'], ao: ['雪松', '檀香', '沒藥'] },
    11: { n: '群聚廳', md: '心包經', tm: '19:00-21:00', th: '我在保護什麼？', de: '封閉、防禦、孤立', le: '開放、真實、親密', sp: ['表面開朗但其實不讓人靠近', '害怕真正的親密'], sq: ['你害怕被看見什麼？'], ao: ['玫瑰草', '橙花', '廣藿香'] },
    12: { n: '靜觀苑', md: '三焦經', tm: '21:00-23:00', th: '我哪裡不平衡？', de: '失衡、分裂、不協調', le: '整合、平衡、和諧', sp: ['生活各方面嚴重不平衡', '身心失調的感覺'], sq: ['你的生活哪裡失衡了？'], ao: ['天竺葵', '乳香', '花梨木'] }
  };
  ...
  const _YT = {
    ...
    4: { kw: '建設', th: '穩固基礎', ad: '打地基、建立結構', pc: '4宮（家族苑）', fc: '這一年宇宙在問你：「你該丟掉什麼？」' },
    5: { kw: '變化', th: '轉型突破', ad: '擁抱改變、勇於冒險', pc: '5宮（創造殿）', fc: '這一年宇宙在問你：「你消化不了什麼？」' },
    6: { kw: '責任', th: '照顧收成', ad: '家庭責任、收穫付出', pc: '6宮（執行廳）', fc: '這一年宇宙在問你：「你想太多什麼？」' },
    7: { kw: '沉澱', th: '內在探索', ad: '反思學習、獨處充電', pc: '7宮（合作殿）', fc: '這一年宇宙在問你：「你渴望什麼愛？」' },
    8: { kw: '收穫', th: '豐盛成就', ad: '事業成功、財務豐收', pc: '8宮（轉化廳）', fc: '這一年宇宙在問你：「你分不清什麼？」' },
    9: { kw: '結束', th: '完成釋放', ad: '放下舊有、準備新循環', pc: '9宮（遠航苑）', fc: '這一年宇宙在問你：「你扛著什麼？」' },
    11: { kw: '靈性覺醒', th: '直覺開啟', ad: '信任直覺、靈性成長', pc: '11宮（群聚廳）', fc: '宇宙在問你：「你在保護什麼？」' },
    22: { kw: '大師建造', th: '願景落地', ad: '建立長遠系統', pc: '全宮位', fc: '建造服務眾生的橋樑' },
    33: { kw: '大師守護', th: '無條件的愛', ad: '修復自己與他人', pc: '全宮位', fc: '成為愛的管道' }
  };
