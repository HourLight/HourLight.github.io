...
完整論述頁面：cognitive-aromatherapy-theory.html（557行，9章，9篇學術引用）

~~

## 座標哲學（Coordinate Philosophy）

核心概念：33 套命理系統就像 33 種 GPS 訊號，交叉定位你的人生座標。不是算命，是定位。

三維時間萃取理論：
► 西曆生日 → 社會身份（太陽週期、星座、生命靈數）
► 農曆生日 → 情緒潮汐（月亮週期、節氣、馥靈秘碼）
► 出生時辰 → 身體潛能（時辰經絡、紫微命宮、人類圖）

東方天人合一 × 西方大數據思維：多維度數據交叉比對，找出隱藏模式。跟 Netflix 推薦算法的邏輯本質相同。

科學隱喻連結（明標「隱喻非證明」）：榮格共時性（1952）、原型理論、蝴蝶效應（Lorenz 1963）、觀測者效應。

完整論述頁面：coordinate-philosophy.html（693行，15條學術引用，33系統互動篩選器）

~~

## HOUR LIGHT 未來美容學苑（Knowledge Hub）

品牌子線：讓身體與心靈同時被紓壓，讓每一位美業人都成為覺察師。

入口頁面：knowledge-hub.html
知識頁面（8 頁深度內容，每頁 1200+ 行）：
► aromatherapy-science.html — 芳療科學基礎（化學分類/吸收途徑/免疫/GC-MS/安全）
► certification-guide.html — 認證指南（五大國際認證比較/台灣現況/備考/職涯）
► blending-guide.html — 調香指南（六大家族/進階配方/四季/情緒/濃度速算）
► yuan-chen-guide.html — 元辰宮指南（歷史/房間/進階解讀/牌卡對應/冥想）
► kids-aromatherapy.html — 兒童芳療（安全濃度/嬰兒按摩/情緒牌卡/親子活動）
► reiki-guide.html — 靈氣指南（12手位/經絡對照/7項研究/選課指南）
► skincare-science.html — 護膚科學（膚質分類/5大成分/季節護膚/DIY配方）
► massage-guide.html — 按摩指南（生理機制/經絡vs西方/禁忌/精油配方）
...
► □ 秘密協議：對外內容絕不透露網站是 AI/Claude Code 建的？
...
「秘密協議」
► 網站是用 Claude Code 建的這件事，絕對不能在對外內容中透露
► ai-guide-claude-code.html 是公開教學頁，但內容寫的是「美業朋友用 AI 工具」，不是逸君自己
► 任何對外文案、SEO 文章、社群內容，都不能暗示馥靈之鑰官網是 AI 生成的
► 這是我們的秘密
...
► Firestore rules 補齊 17 個缺失集合
► ai-match-frameworks.js 改為按需載入（省 7MB 初始載入）

~~

## 四、芳療共享園地（aroma-garden.html）

### 定位
芳療學員專屬知識寶庫，同時作為行銷漏斗入口（免費知識 → 報名課程 → 升級馥靈之鑰會員）。

### 門控策略
► 大部分內容公開（知識庫、配方、冷知識、基底油、FAQ）
► NAHA 認證重點 + 模擬考題需學員代碼解鎖
► 代碼驗證：Firestore `garden_codes/{CODE}` + 硬編碼備援（AROMA2026 / HISTUDIO / NAHA2026）

### 內容架構（19 個導覽區塊）
► 精油核心知識庫（9 張卡片）
► 25 支核心精油速查表（拉丁學名、萃取、成分、注意事項）
► 精油化學官能基完整分類（9 大類深度解析 + 毒性速記）
► 芳療歷史年表（西元前 6000 年 → 1985 年 IFA，12 個關鍵節點）
► 人體八大系統 × 精油應用
► 按摩手法（瑞典式五大手法 + 嬰兒按摩 + SPA 經絡要點）
► 12 經絡 × 精油 × 情緒對照表（含子午流注時辰）
► 人體生理學基礎 7 篇（皮膚/嗅覺/內分泌/自律神經/淋巴/肌骨/消化）
► 精油安全速查卡（光敏性/孕婦/嬰幼兒/濃度速算/保質期）
► 冷知識專區（奇經八脈 6 條 + 身體密碼 8 則）
► 特殊族群（寵物/兒童/孕婦/老年人）
► NAHA 認證重點（代碼鎖）
► 模擬考題 18 題（代碼鎖）
► 精油配方搜尋器 305 個（即時搜尋 + 11 分類篩選）
► 芳療心理學 × 馥靈之鑰（6 張深度卡片）
► 心理測驗推薦 6 個
► 基底油大全 12 種
► 芳療個案報告模板 + 2 份去名化範例
...
### 配方搜尋器（assets/js/aroma-formulas.js）
► 305 個配方，11 個分類
► 疼痛 34 / 情緒 43 / 皮膚 36 / 呼吸 19 / 消化 18 / 女性 21 / 免疫 18 / DIY 33 / 頭髮 15 / 寵物 9 / 兒童 15
► 即時關鍵字搜尋（症狀或精油名稱）
► 分類按鈕篩選

### 創辦人教學資料路徑
► `D:/OneDrive/桌面/HiStudio/`（NAHA 講義、授課檔案、教材、考試題目）
► `D:/OneDrive/桌面/桌面文件/09_芳療專業資料/`（精油、經絡、個案、德育芳療）
► `D:/OneDrive/桌面/桌面文件/08_身心靈/`（七脈輪、生命靈數、神祕學）
► `D:/OneDrive/桌面/桌面文件/04_論文與學術研究/`（碩士論文、SPSS 統計）
